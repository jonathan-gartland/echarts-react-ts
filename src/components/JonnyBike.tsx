function JonnyBike() {
  ...
  return (
    <div>
      <div>
        <h2 className="w-4/5 text-4xl left-36 px-36 pt-4 mt-6 border-2 border-gray-500 bg-blue-100 relative justify-center rounded-xl pb-4">
          Bikes: Rideable or within a tune up of being rideable
        </h2>
        <table className="min-w-64 divide-y divide-gray-200 mt-4 text-sm w-4/5 mx-auto border border-gray-300 rounded-xl">
          <thead className="bg-gray-300">
            <tr>
              ...
              <th className="px-4 py-3 font-sm font-bold text-gray-500 uppercase tracking-wider">
                Manufactured
              </th>
              <th className="px-4 py-3 font-bold text-gray-500 uppercase tracking-wider">
                Material
